            ...
            'en_US' => [
                [
                    ...
                    'content'  =>
                        ...
                        Html::tag('div', '[site-features icon1="general/icon-truck.png" title1="Free Shipping" subtitle1="Orders $50 or more" icon2="general/icon-purchase.png" title2="Free Returns" subtitle2="Within 30 days" icon3="general/icon-bag.png" title3="Get 20% Off 1 Item" subtitle3="When you sign up" icon4="general/icon-operator.png" title4="Support Center" subtitle4="24/7 amazing services"][/site-features]') .
                        Html::tag('div',
            ...
            'vi'    => [
                [
                    ...
                    'content'  =>
                        ...
                        Html::tag('div', '[site-features icon1="general/icon-truck.png" title1="Miễn phí vận chuyển" subtitle1="Cho đơn hàng từ $50" icon2="general/icon-purchase.png" title2="Miễn phí đổi trả" subtitle2="Trong vòng 30 ngày" icon3="general/icon-bag.png" title3="Giảm 20% mỗi 1 sản phẩm" subtitle3="Khi bạn đăng ký thành viên" icon4="general/icon-operator.png" title4="Hỗ trợ" subtitle4="24/7 dịch vụ tuyệt vời"][/site-features]') .
                        Html::tag('div',
