                        ...
                        <form class="form--auth form--login" method="POST" action="{{ route('customer.login.post') }}">
                            ...
                            <div class="form__content">
                                <div class="form-group">
                                    ...
                                    <input name="email" class="form-control" id="txt-email" type="email" value="{{ old('email') }}" placeholder="{{ __('Please enter your email address') }}">
                                    @if ($errors->has('email'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form__password">
                                        <input type="password" class="form-control" name="password" id="txt-password" placeholder="{{ __('Please enter your password') }}">
                                    </div>
