                                ...
                                <div class="header-info header-info-right">
                                        <ul>
                                            ...
                                            @if (is_plugin_active('ecommerce'))
                                                ...
                                                @else
                                                    <li>
                                                        <a href="{{ route('customer.login') }}" style="padding-right: 5px;">{{ __('Log In') }}</a>
                            ...
                            <ul>
                                @if (is_plugin_active('marketplace'))
                                    <li class="nav-marketplace">
                                        <a href="{{ !auth('customer')->check() ? route('customer.login') : (auth('customer')->user()->is_vendor ? route('marketplace.vendor.dashboard') : route('marketplace.vendor.become-vendor')) }}">{{ __('Sell On BargainBay') }}</a>
                                    </li>
                                @endif
                            </ul>
                        @endif
                                ...
                                <div class="header-action-2">
                                    <div class="header-action-icon-2">
                                        <a href="{{ route('public.compare') }}" class="compare-count">
                                            ...
                                            <span class="pro-count white"><span>@if (auth('customer')->check())<span>{{ auth('customer')->user()->wishlist()->count() }}</span>@else <span>{{ Cart::instance('compare')->count() }} </span> @endif</span>
                                        </a>
                                    </div>
                                    @if (EcommerceHelper::isWishlistEnabled())
                                        <div class="header-action-icon-2">
