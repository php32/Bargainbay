                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" data-title="{{ __('Quantity') }}">
                                                <div class="detail-qty border radius  m-auto">
                                                    ...
                                                    <a href="javascript:void()" class="qty-down"><i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                                    <span class="qty-val">{{ $cartItem->qty }}</span>
                                                    <a href="javascript:void()" class="qty-up"><i class="fa fa-caret-up" aria-hidden="true"></i></a>
                                                </div>
                                            </td>
