                    ...
                    <div class="col-md-4">
                        ...
                        <div class="dashboard-menu">
                            <ul class="nav flex-column">
                                ...
                                @endforeach
                                @if (auth('customer')->user()->is_vendor == 0)
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('customer.wallet') }}"><i class="fa fa-wallet mr-15"></i> {{ __('Wallet') }}</a>
                                    </li>
                                @endif
                                @if (is_plugin_active('marketplace'))
                                    @if (auth('customer')->user()->is_vendor)
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('marketplace.vendor.dashboard') }}"><i class="fa fa-shopping-bag mr-15"></i> {{ __('Vendor dashboard') }}</a>
                                        </li>
                                    @else
                                        <li class="nav-item @if(Route::currentRouteName() == 'marketplace.vendor.become-vendor')active @endif">
                                            <a class="nav-link" href="{{ route('marketplace.vendor.become-vendor') }}"><i class="fa fa-shopping-bag mr-15"></i> {{ __('Become a vendor') }}</a>
                                        </li>
                                    @endif
                                @endif
                                <li class="nav-item @if(Route::currentRouteName() == 'customer.logout')active @endif">
                                    <a class="nav-link" href="{{ route('customer.logout') }}"><i class="fa fa-sign-out-alt mr-15"></i> {{ __('Logout') }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
