                ...
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        ...
                        <div class="form-group">
                            ...
                            <label class="hrv-label">
                                <input type="radio" name="wishlist_enabled" class="hrv-radio" value="1"
                                       @if (EcommerceHelper::isWishlistEnabled()) checked @endif>{{ trans('core/setting::setting.general.yes') }}
                            </label>
                            <label class="hrv-label">
                                <input type="radio" name="wishlist_enabled" class="hrv-radio"
                                       value="0"
                        ...
                        <div class="form-group">
                            ...
                            <label class="hrv-label">
                                <input type="radio" name="compare_enabled" class="hrv-radio" value="1"
                                       @if (EcommerceHelper::isCompareEnabled()) checked @endif>{{ trans('core/setting::setting.general.yes') }}
                            </label>
                            <label class="hrv-label">
                                <input type="radio" name="compare_enabled" class="hrv-radio"
                                       value="0"
