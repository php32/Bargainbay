...
Route::group([
    ...
    Route::post('deposit-wallet', [
        'as'   => 'deposit.wallet',
        'uses' => 'WalletController@postDepositeWallet',
    ]);

    Route::post('widthdraw-wallet', [
        'as'   => 'widthdraw.wallet',
        'uses' => 'WalletController@postWidthdrawWallet',
    ]);

    Route::post('wallet-process/{token}', [
        'as'   => 'wallet.process',
        'uses' => 'WalletController@postWalletProcess',
    ]);

    Route::get('recover', [
        'as'   => 'recover',
        'uses' => 'WalletController@getCheckoutRecover',
    ]);
});
